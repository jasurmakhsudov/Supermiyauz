...
<body> 
    ...
    <div class="white noalign">
        <hr>
        <p class="sub-text text-bold"><span class="underline">BLACK CUBE</span> Anti-dangasalik kursimni 6 soat ichida siz qoldirgan @gmail.com elektron manzilingizga ko`rish uchun dostup beraman.</p>
        <p class="sub-text text-bold">Agar tushunmovchilik bo`lsa <a href="https://t.me/xayotsharapov" class="green underline"> bu yerni bosib </a> texnik jamoam bilan bog`laning, ular sizga albatta yordam berishadi.</p>
    </div>
    </section>
